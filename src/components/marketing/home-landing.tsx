...
import { Search, ShieldCheck, Wifi, Ticket, User, Briefcase } from "lucide-react";
      ...
      <main className="max-w-7xl mx-auto px-6 py-20 grid md:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-4">
            <div className="relative">
              ...
              <Input
                ...
                className="w-full pl-12 pr-4 py-4 rounded-xl border border-slate-200 focus:ring-2 focus:ring-blue-500 focus:outline-none shadow-sm h-14"
              />
            </div>
            ...
            <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-xl">
              ...
              <div className="flex gap-2">
                <Input
                  ...
                  className="flex-1 px-4 py-2 rounded-lg border border-slate-200 text-sm focus:outline-blue-500"
                />
        ...
        <div className="bg-white p-10 rounded-3xl border border-slate-200 shadow-2xl relative overflow-hidden">
          ...
          <div className="space-y-4">
            <Button
              variant="outline"
              className="w-full flex items-center justify-center gap-3 border-2 border-slate-100 py-3 rounded-xl hover:bg-slate-50 transition-all group h-14"
            >
              <svg
                className="w-5 h-5"
                viewBox="0 0 23 23"
